...
const BohoLogin = () => {
  ...
  useEffect(() => {
    const savedPreference = localStorage.getItem('boho_remember_me');
    if (savedPreference) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      localStorage.setItem('boho_remember_me', rememberMe ? 'true' : 'false');
      toast({
        title: "Welcome back!",
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({
        ...
        description: "Welcome to Boho Boho!",
      });
      navigate('/boho/menu');
    } else {
      toast({
