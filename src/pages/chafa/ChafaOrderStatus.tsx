...
const ChafaOrderStatus = () => {
  ...
  const handleShare = () => {
    const url = `${window.location.origin}/chafa/order/${orderId}`;
    if (navigator.share) {
      navigator.share({
        title: `Order #${orderId}`,
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <Button onClick={() => navigate('/chafa/menu')}>Back to Menu</Button>
          </CardContent>
        </Card>
      </div>
    );
...
export default ChafaOrderStatus;
