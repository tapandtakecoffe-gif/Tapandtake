...
const ChafaLogin = () => {
  ...
  useEffect(() => {
    const savedPreference = localStorage.getItem('chafa_remember_me');
    if (savedPreference) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      localStorage.setItem('chafa_remember_me', rememberMe ? 'true' : 'false');
      toast({
        title: "Welcome back!",
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({
        ...
        description: "Welcome to Chafa Cafe And Studio!",
      });
      navigate('/chafa/menu');
    } else {
      toast({
